        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">
              Connecting the World with Intelligent Networks
            </p>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto mb-8">
              Navigate the communications revolution. From 5G networks and IoT connectivity to cloud infrastructure and digital transformation, the industry is evolving at unprecedented speed.
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              The only way forward is to move from traditional networks to intelligent systems — where data, connectivity, and people work together seamlessly.
            </p>
            <a 
              href="#contact" 
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
                <div className="text-4xl font-bold text-[#d0ed01] mb-2">89%</div>
                <p className="text-gray-300 text-sm">of telecom companies are investing in 5G infrastructure</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#6248ff]/10 to-transparent p-6 rounded-2xl border border-[#6248ff]/20">
                <div className="text-4xl font-bold text-[#6248ff] mb-2">74%</div>
                <p className="text-gray-300 text-sm">of enterprises rely on cloud communications</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
                <div className="text-4xl font-bold text-[#d0ed01] mb-2">67%</div>
                <p className="text-gray-300 text-sm">of operators struggle with network optimization</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#6248ff]/10 to-transparent p-6 rounded-2xl border border-[#6248ff]/20">
                <div className="text-4xl font-bold text-[#6248ff] mb-2">82%</div>
                <p className="text-gray-300 text-sm">of network data remains unanalyzed for insights</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
          ...
          <div className="mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#d0ed01]">
              Why Choose Symbiotes for Communications?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-[#6248ff]">Network Expertise</h3>
                <p className="text-gray-300">
                  Deep understanding of telecommunications, network infrastructure, and connectivity challenges.
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-[#6248ff]">Connectivity Innovation</h3>
                <p className="text-gray-300">
                  Latest 5G, IoT, and edge computing technologies for next-generation networks.
                </p>
              </div>
              <div className="text-center">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-[#d0ed01] to-[#6248ff] rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-gray-300">
                  Track record of delivering measurable improvements in network performance, efficiency, and customer experience.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gradient-to-r from-[#6248ff]/20 to-[#d0ed01]/20 p-12 rounded-2xl border border-[#d0ed01]/30">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Transform Your Communications Infrastructure
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
              The Communications industry doesn't need another upgrade — it needs intelligent transformation. Symbiotes helps build that future — connecting data, networks, and people into one intelligent ecosystem.
            </p>
            <p className="text-lg text-[#d0ed01] font-bold mb-8">
              Your next connection deserves systems that can think. Let's build them together.
            </p>
