        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">
              Revolutionizing Financial Markets with Intelligence
            </p>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto mb-8">
              Navigate the capital markets transformation. From algorithmic trading and risk management to regulatory compliance and market analytics, the industry is evolving at lightning speed.
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              The only way forward is to move from traditional trading to intelligent systems — where data, algorithms, and people work together seamlessly.
            </p>
            <a 
              href="#contact" 
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
                <div className="text-4xl font-bold text-[#d0ed01] mb-2">92%</div>
                <p className="text-gray-300 text-sm">of trading volume is now executed by algorithms</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#6248ff]/10 to-transparent p-6 rounded-2xl border border-[#6248ff]/20">
                ...
                <p className="text-gray-300 text-sm">of institutional investors use AI for decision making</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
                <div className="text-4xl font-bold text-[#d0ed01] mb-2">65%</div>
                <p className="text-gray-300 text-sm">of firms struggle with real-time data processing</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#6248ff]/10 to-transparent p-6 rounded-2xl border border-[#6248ff]/20">
                <div className="text-4xl font-bold text-[#6248ff] mb-2">84%</div>
                <p className="text-gray-300 text-sm">of market data remains unanalyzed for insights</p>
              </div>
              <div className="text-center bg-gradient-to-br from-[#d0ed01]/10 to-transparent p-6 rounded-2xl border border-[#d0ed01]/20">
                <div className="text-4xl font-bold text-[#d0ed01] mb-2">71%</div>
                <p className="text-gray-300 text-sm">of operational costs are spent on compliance and reporting</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#d0ed01]">
              Why Choose Symbiotes for Capital Markets?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-[#6248ff]">Market Expertise</h3>
                <p className="text-gray-300">
                  Deep understanding of capital markets, trading systems, and financial regulations across global markets.
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-[#6248ff]">Trading Innovation</h3>
                <p className="text-gray-300">
                  Latest AI, machine learning, and algorithmic trading technologies for competitive advantage.
                </p>
              </div>
              <div className="text-center">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-[#d0ed01] to-[#6248ff] rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-gray-300">
                  Track record of delivering measurable improvements in trading performance, risk management, and operational efficiency.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gradient-to-r from-[#6248ff]/20 to-[#d0ed01]/20 p-12 rounded-2xl border border-[#d0ed01]/30">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
              The Capital Markets industry doesn't need another upgrade — it needs intelligent transformation. Symbiotes helps build that future — connecting data, algorithms, and people into one intelligent ecosystem.
            </p>
            <p className="text-lg text-[#d0ed01] font-bold mb-8">
              Your next trade deserves systems that can think. Let's build them together.
            </p>
