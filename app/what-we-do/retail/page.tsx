        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">
              Revolutionizing Retail with Intelligent Commerce
            </p>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto mb-8">
              Navigate the retail revolution. From omnichannel experiences and AI-powered personalization to supply chain optimization and digital transformation, the industry is evolving rapidly.
            </p>
          ...
          <div className="text-center bg-gradient-to-r from-[#6248ff]/20 to-[#d0ed01]/20 p-12 rounded-2xl border border-[#d0ed01]/30">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
              The Retail industry doesn't need another upgrade — it needs intelligent transformation. Symbiotes helps build that future — connecting data, systems, and people into one intelligent ecosystem.
            </p>
