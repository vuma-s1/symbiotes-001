    ...
    <section id="contact" className="relative py-20 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-brand-primary to-brand-secondary text-transparent bg-clip-text mb-6">
                Get in Touch
              </h2>
          ...
          <div className="bg-dark-bg p-8 rounded-xl border border-brand-purple/20">
            <form className="space-y-6">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-4 py-2 bg-dark-card border border-brand-purple/20 rounded-lg text-white focus:outline-none focus:border-brand-primary"
              ...
              <button
                type="submit"
                className="w-full py-3 px-6 bg-brand-primary text-black font-medium rounded-lg hover:bg-brand-secondary transition-colors"
              >
                Send Message
              </button>
            </form>
