...
const NeonSurveyMockup = () => {
  return (
    <>
      <section className="relative flex flex-col items-center justify-center min-h-[80vh] py-24 bg-black pb-12">
        ...
        <div className="w-full flex justify-center mt-16">
          <div className="w-full rounded-2xl border-2 border-[#d0ed01] p-8 bg-black text-center shadow-[0_0_24px_2px_#d0ed01]">
            <h2 className="text-2xl md:text-3xl font-bold text-[#d0ed01]">
